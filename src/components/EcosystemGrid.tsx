...
export default function EcosystemGrid() {
  return (
    <section className="py-20 px-4 max-w-7xl mx-auto">
      <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">خدمات المنصة</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-8 shadow-sm border border-blue-200 hover:shadow-xl transition-all duration-300 cursor-default">
          ...
          <p className="text-gray-600 leading-relaxed">
            منصات تعليمية مخصصة (قِرائتي وكتابي) لدعم أولياء الأمور والطلاب. <span className="text-blue-600 font-bold text-sm">(قريباً)</span>
          </p>
        </div>
